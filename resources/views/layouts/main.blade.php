		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="/"><img src="/img/pts.png" style="width:80px; height:70px;" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item {{Request::is('register') ? 'active' : ''}}"><a class="nav-link" href="/register">Sign-Up</a></li>
